...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            // Block normal movement during roll
        ...
        private void StartRoll()
        {
            ...
            // Roll toward movement direction, or forward if standing still
            if (_input.move != Vector2.zero)
            {
                Vector3 inputDir = new Vector3(_input.move.x, 0, _input.move.y).normalized;
                _rollDirection = Quaternion.Euler(0, _mainCamera.transform.eulerAngles.y, 0) * inputDir;
            }
            else
            {
        ...
        private void HandleRoll()
        {
            ...
            // Move in roll direction, keep gravity
